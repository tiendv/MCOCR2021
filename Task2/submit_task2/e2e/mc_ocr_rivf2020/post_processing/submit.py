...
with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/street.txt") as f:
    content = f.readlines()
LIST_STREET_DEF = [x.strip() for x in content] 

with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/seller.txt") as f:
    content = f.readlines()
LIST_SELLER_DEF = [x.strip() for x in content] 

with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/phone.txt") as f:
    content = f.readlines()
LIST_PHONE_DEF = [x.strip() for x in content] 

with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/prices.txt") as f:
    content = f.readlines()
LIST_PRICES_DEF = [x.strip() for x in content] 

with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/prices_prioritize.txt") as f:
    content = f.readlines()
LIST_PRICES_PRIORITIZE_DEF = [x.strip() for x in content] 

with open("e2e/mc_ocr_rivf2020/post_processing/field_dictionary/date.txt") as f:
    content = f.readlines()
...
if __name__ == "__main__":
    ...
    name = "mcocr_private_145120etjwj"
